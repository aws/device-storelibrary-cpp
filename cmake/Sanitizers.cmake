function(myproject_enable_sanitizers project_name ENABLE_SANITIZER_ADDRESS ENABLE_SANITIZER_UNDEFINED_BEHAVIOR
    ...
    if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
        ...
        if(${ENABLE_SANITIZER_MEMORY} AND CMAKE_CXX_COMPILER_ID MATCHES ".*Clang")
            ...
            if("address" IN_LIST SANITIZERS OR "thread" IN_LIST SANITIZERS)
                message(WARNING "Memory sanitizer does not work with Address or Thread sanitizer enabled")
            else()
        ...
        if(NOT "${LIST_OF_SANITIZERS}" STREQUAL "")
            if(NOT MSVC)
                ...
                target_compile_definitions(
                    ${project_name} INTERFACE _DISABLE_VECTOR_ANNOTATION _DISABLE_STRING_ANNOTATION
                )
